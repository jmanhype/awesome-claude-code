...
- [PitchDocs](https://github.com/littlebearapps/pitchdocs) - Documentation generation plugin with 13 slash commands for README, CHANGELOG, AI context files, and more; add with `/plugin marketplace add littlebearapps/lba-plugins`.
