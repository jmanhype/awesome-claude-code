...
- [MyVibe](https://www.myvibe.so) - Instant publishing skill for Claude Code. Deploy projects to live URLs with `/myvibe:publish`. Auto-detects project type (HTML, Vite, React, Next.js) and handles builds automatically.
