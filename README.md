...
## Plugins & Extensions
- [AWS Cost Saver](https://github.com/prajapatimehul/claude-aws-cost-saver) - Plugin that scans AWS accounts for wasted spend with 173 automated checks across EC2, RDS, S3, Lambda, and more. Uses ML-powered recommendations from AWS Compute Optimizer and real pricing from AWS API; add with `/plugin marketplace add prajapatimehul/claude-aws-cost-saver`.
