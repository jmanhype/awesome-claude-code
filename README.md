...
- [Iris](https://github.com/iris-eval/mcp-server) - MCP-native agent eval & observability. Log traces, evaluate output quality (PII, injection, hallucination, cost), track per-agent costs. Agents discover it automatically. MIT licensed.
